...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/zeex-ui/index"] = factory();
	else
		root["npm/zeex-ui/index"] = factory();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_weex_bindingx__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_weex_bindingx___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_weex_bindingx__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  created: function created() {
    ...
    this.$nextTick(function () {
      setTimeout(function () {
        dom.getComponentRect(_this.$refs['magic-item-ref-' + _this.uuid], function (res) {
          if (res.result) {
            _this.containerHeight = res.size.height;
          }
        });
      }, 1);
      _this.touchstart();
  ...
  methods: {
    initPlugin: function initPlugin() {
      var that = this;
      var _o = {};
      var _close = function _close(ref) {
        that.resetView(ref);
      };
      ...
      if (!this.$parent.ZpmMagicItem) {
        ...
        this.$parent.ZpmMagicItem.closeAll = function () {
          for (var i = 0; i < that.$parent.ZpmMagicItem.list.length; i++) {
    ...
    closeOther: function closeOther() {
      ...
      for (var i = 0; i < this.$parent.ZpmMagicItem.list.length; i++) {
    ...
    touchstart: function touchstart() {
      ...
      if (this.isInAnimation) {
        if (Number(this.gesToken) !== 0) {
          __WEBPACK_IMPORTED_MODULE_0_weex_bindingx___default.a.unbind({
            eventType: 'pan',
            token: this.gesToken
          });
          this.gesToken = 0;
      ...
      var target = this.$refs['magic-item-ref-' + this.uuid].ref;
      var trigger = this.$refs['magic-item-trigger-ref-' + this.uuid].ref;
      var expressionXOrigin = 'min(x+' + this.x + ',0)';
      var gesTokenObj = __WEBPACK_IMPORTED_MODULE_0_weex_bindingx___default.a.bind({
        eventType: 'pan',
        anchor: trigger,
        props: [{
          element: target,
    ...
    bindTiming: function bindTiming() {
      ...
      var target = this.$refs['magic-item-ref-' + this.uuid].ref;
      var totalWidth = this.subItems.length > this.maxItemLength ? this.maxItemLength * 200 : this.subItems.length * 200;
      var exitOrigin = 't>400';
      var changedX = 0;
      var finalX = 0;
      ...
      var expressionX = 'easeOutQuart(t,' + this.x + ',' + changedX + ',400)';
      __WEBPACK_IMPORTED_MODULE_0_weex_bindingx___default.a.bind({
        eventType: 'timing',
        ...
        if (e.state === 'end' || e.state === 'exit') {
          _this4.x = finalX;
          _this4.isInAnimation = false;
          _this4.isOpen = _this4.x !== 0;
        }
      });
    },
    resetView: function resetView(ref) {
      var _this5 = this;

      this.isInAnimation = true;
      var target = ref ? this.$refs[ref].ref : this.$refs['magic-item-ref-' + this.uuid].ref;
      var changedX = -this.x;
      var finalX = 0;
      var exitOrigin = 't>400';
      var expressionX = 'easeInOutExpo(t,' + this.x + ',' + changedX + ',400)';
      __WEBPACK_IMPORTED_MODULE_0_weex_bindingx___default.a.bind({
        eventType: 'timing',
        exitExpression: exitOrigin,
        props: [{
    ...
    emitCustomEvent: function emitCustomEvent(e) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__packages_zpm_magic_item__ = __webpack_require__(2);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "ZpmMagicItem", function() { return __WEBPACK_IMPORTED_MODULE_0__packages_zpm_magic_item__["a"]; });
/**
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index_vue__ = __webpack_require__(3);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__index_vue__["a"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__happypack_loader_id_babel_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__(0);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9c05ef60_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9c05ef60_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9c05ef60_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__);
var disposed = false
...
/* scopeId */
var __vue_scopeId__ = "data-v-9c05ef60"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__happypack_loader_id_babel_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9c05ef60_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["default"],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "packages/zpm-magic-item/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9c05ef60", Component.options)
  } else {
    hotAPI.reload("data-v-9c05ef60", Component.options)
  }
...
var update = __webpack_require__(7)("12a761f8", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9c05ef60\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9c05ef60\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
...
throw new Error("Module build failed: Error: Cannot find module 'weex-vue-precompiler'\n    at Function.Module._resolveFilename (module.js:489:15)\n    at Function.Module._load (module.js:439:25)\n    at Module.require (module.js:517:17)\n    at require (internal/module.js:11:18)\n    at Array.postTransformNode (/Keith/git/ls/zeex-ui/webpack.config.js:142:11)\n    at closeElement (/Keith/git/ls/zeex-ui/node_modules/vue-template-compiler/build.js:2398:24)\n    at Object.end (/Keith/git/ls/zeex-ui/node_modules/vue-template-compiler/build.js:2526:7)\n    at parseEndTag (/Keith/git/ls/zeex-ui/node_modules/vue-template-compiler/build.js:558:19)\n    at parseHTML (/Keith/git/ls/zeex-ui/node_modules/vue-template-compiler/build.js:374:11)\n    at parse (/Keith/git/ls/zeex-ui/node_modules/vue-template-compiler/build.js:2402:3)\n    at baseCompile (/Keith/git/ls/zeex-ui/node_modules/vue-template-compiler/build.js:4267:13)\n    at compile (/Keith/git/ls/zeex-ui/node_modules/vue-template-compiler/build.js:4242:22)\n    at Object.module.exports (/Keith/git/ls/zeex-ui/node_modules/vue-loader/lib/template-compiler/index.js:39:20)");
