...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__packages_zpm_magic_item__ = __webpack_require__(1);
...
__vue_options__.__file = "/Keith/git/ls/zeex-ui/packages/zpm-magic-item/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-9c05ef60"
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_weex_bindingx__ = __webpack_require__(5);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["zpm_magic_item_container"],
    style: {
      width: _vm.width + 'px',
      backgroundColor: (_vm.subItems[(_vm.subItems.length > _vm.maxItemLength ? (_vm.maxItemLength - 1) : (_vm.subItems.length - 1))].style && _vm.subItems[(_vm.subItems.length > _vm.maxItemLength ? (_vm.maxItemLength - 1) : (_vm.subItems.length - 1))].style.backgroundColor) || '#FFFFFF'
    }
  }, [_c('div', {
    ref: 'magic-item-ref-' + _vm.uuid,
    staticClass: ["zpm_magic_item_wrapper"],
    style: {
    ...
    ref: 'magic-item-trigger-ref-' + _vm.uuid,
    staticClass: ["main_container_mask"],
    style: {
      width: _vm.width + 'px',
      height: _vm.containerHeight + 'px'
    }
  })], 2), _c('div', {
    staticClass: ["sub_items_container"],
    style: {
      width: _vm.width + 'px'
    }
  }, _vm._l((_vm.subItems.slice(0, _vm.maxItemLength)), function(item, index) {
    return _c('div', {
      key: item.event,
      staticClass: ["sub_item_wrapper"],
      style: [{
        height: _vm.containerHeight + 'px'
      }, item.style],
      attrs: {
        "dataEventName": item.event
      },
      on: {
        "click": _vm.emitCustomEvent
      }
    }, [_c('text', {
      style: {
        fontSize: ((item.style && item.style.fontSize) || '28px'),
        color: ((item.style && item.style.color) || '#666666')
      }
