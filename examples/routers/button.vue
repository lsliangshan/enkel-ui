<template>
  <e-page name="button">
    <headers slot="header"></headers>
    <e-button custom-data="123"
              fill
              disabled>button</e-button>
    <div class="line">
      <div class="line-label">Normal Buttons</div>
      <Row :gutter="10">
        <Col>
        <e-button loading
                  @click="notify">button</e-button>
        </Col>
        <Col>
    ...
    <div class="line">
      ...
      <Row :gutter="10">
        <Col>
        <e-button fill
                  loading>button</e-button>
        </Col>
        <Col>
        <e-button fill>button</e-button>
        </Col>
        <Col>
        <e-button fill
                  round>round</e-button>
        </Col>
      </Row>
    </div>
    <div class="line">
      ...
      <Row :gutter="10">
        <Col>
        <e-button outline>button</e-button>
        </Col>
        <Col>
        <e-button outline>button</e-button>
        </Col>
    ...
    <div class="line">
      ...
      <Row :gutter="10">
        <Col>
        <e-button raised>button</e-button>
        </Col>
        <Col>
        <e-button raised
                  fill>fill</e-button>
    ...
    <div class="line">
      ...
      <Row :gutter="10">
        <Col>
        <e-button size="large">button</e-button>
        </Col>
        <Col>
        <e-button size="large"
                  fill>fill</e-button>
      ...
      <Row :gutter="10">
        <Col>
        <e-button size="large"
                  raised>raised</e-button>
        </Col>
        <Col>
        <e-button size="large"
                  raised
                  fill>raised fill</e-button>
        </Col>
      </Row>
    </div>
    <div class="line">
      ...
      <Row :gutter="10">
        <Col>
        <e-button size="small">button</e-button>
        </Col>
        <Col>
        <e-button size="small"
                  outline>outline</e-button>
    ...
    <div class="line">
      ...
      <Row :gutter="10">
        <Col v-for="(item, index) in colors"
             :key="index"
             :span="33">
        <e-button :type="item">{{item}}</e-button>
        </Col>
      </Row>
    </div>
    <div class="line">
